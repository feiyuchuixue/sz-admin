  ...
  >
    ...
    >
      <el-form-item label="统计年限" prop="year">
        <el-input v-model="paramsProps.row.year" placeholder="请填写统计年限" clearable></el-input>
      </el-form-item>
      <el-form-item label="统计月份" prop="month">
        <el-input v-model="paramsProps.row.month" placeholder="请填写统计月份" clearable></el-input>
      </el-form-item>
      <el-form-item label="统计年月" prop="duringTime">
        <el-input
          v-model="paramsProps.row.duringTime"
          placeholder="请填写统计年月"
          clearable
        ></el-input>
      </el-form-item>
      <el-form-item label="教师id" prop="teacherId">
        <el-input
          v-model="paramsProps.row.teacherId"
          placeholder="请填写教师id"
          clearable
        ></el-input>
      </el-form-item>
      <el-form-item label="讲师区分类型" prop="teacherCommonType">
        <el-select
          v-model="paramsProps.row.teacherCommonType"
          clearable
          placeholder="请选择讲师区分类型"
        >
          <el-option
      ...
      <el-form-item label="授课总数" prop="totalTeaching">
        <el-input-number
          v-model="paramsProps.row.totalTeaching"
          :precision="0"
          :min="1"
          :max="999999"
        />
      ...
      <el-form-item label="服务班次数" prop="totalClassCount">
        <el-input-number
          v-model="paramsProps.row.totalClassCount"
          :precision="0"
          :min="1"
          :max="999999"
        />
      ...
      <el-form-item label="课时总数" prop="totalHours">
        <el-input-number
          v-model="paramsProps.row.totalHours"
          :precision="0"
          :min="1"
          :max="999999"
        />
      ...
      <el-form-item label="备注" prop="remark">
        <el-input v-model="paramsProps.row.remark" placeholder="请填写备注" clearable></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
