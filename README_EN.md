...
<h4 align="center">An open-source RBAC admin scaffold built with Spring Boot 4, JDK 25, Vue 3 and Vite 7</h4>
...
- **Backend stack**: Spring Boot 4, JDK 25, Sa-Token, MyBatis-Flex, Liquibase and Redis.
...
| --- | --- |
| Modern stack | Spring Boot 4, JDK 25, Vue 3.5, Vite 7.3 and TypeScript 5.9. |
...
| JDK 25 | Required to build and run the matching v2.1.0 backend; Java 21 is not supported. |
